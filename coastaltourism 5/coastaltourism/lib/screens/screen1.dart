...
import 'package:coastaltourism/screens/services/firebase_service.dart' as firebase;
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) =>rating.RatingScreen(username: widget.username)));
              },
            ),
          ListTile(
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => HotelSelectionScreen(hotelData: hotels)));
                  },
                  child: Container(
                    height: 150,
                    width: 200,
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LocationScreen(beachName: "india", Latitude: 20.5937, Longitude: 78.9629)));
                  },
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Container(
                  ...
                  title: InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) =>rating.RatingScreen(username: widget.username)));
                      },
                      child: Text("Likes")),
                  selectedColor: Colors.blue,
                ),
