...
class BeachSelectionScreen extends StatefulWidget {
  ...
  BeachSelectionScreen({required this.stateBeachesData,required this.username});
      ...
      bottomNavigationBar: SalomonBottomBar(
        ...
        items: [
          ...
          SalomonBottomBarItem(
            ...
            title: InkWell(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context)=>RatingScreen(username: widget.username)));
              },
              child: Text("Likes")),
            selectedColor: Colors.blue,
          ),
          SalomonBottomBarItem(
            ...
            title: InkWell(
              onTap: () {
                 Navigator.push(context, MaterialPageRoute(builder: (context)=>BeachSelectionScreen(stateBeachesData: widget.stateBeachesData, username: widget.username)));
              },
              child: Text("Search")),
            selectedColor: Colors.blue,
          ),
