...
class Data4 extends StatefulWidget {
  ...
  @override
  State<Data4> createState() => _Data2State();
}

class _Data2State extends State<Data4> {
  ...
  static Detaileds d3 = Detaileds(
    logo: "images/save.png",
    title: "Accessability and transletions",
  );
  ...
  static Detaileds d5 = Detaileds(
    logo: "images/save.png",
    title: "Data use and media quality",
  );
   static Detaileds d6 = Detaileds(
    logo: "images/save.png",
    title: "App website permition",
  );
  ...
  final List<Detaileds> object1 = [d1, d2, d3, d4,d5,d6];
  @override
